...
## 进度跟踪（Burndown）
- 统计：总 8 | 已完成 8 | 进行中 0 | 待办 0（更新于 2025-09-06）
- 状态明细：
  - [x] EP-01-S1 身份证唯一去重与冲突提示（Done，2025-09-06）
  - [x] EP-01-S2 档案查看（脱敏/原始切换）（Done，2025-09-06）
  - [x] EP-01-S3 档案搜索/筛选（Done，2025-09-06）
  - [x] EP-03-S1 志愿者提交服务记录（Done，2025-09-06）
  - [x] EP-03-S2 社工审核记录（Done，2025-09-06）
  - [x] EP-04-S1 活动发布与列表（Done，2025-09-06）
  - [x] EP-04-S2 报名/取消/签到（Done，2025-09-06）
  - [x] EP-06-S1 字段级权限申请与审批（Done，2025-09-06）
...
- v0.2 更新进度：EP-01-S1 标记 Done（2025-09-06），完成率 1/8；其余保持 Planned。
- v0.3 更新进度：EP-03-S1 标记 Done（2025-09-06），完成率 2/8。
- v0.4 更新进度：EP-01-S2 标记 Done（2025-09-06），完成率 3/8。
- v0.5 更新进度：EP-06-S1 标记 Done（2025-09-06），完成率 4/8。
- v0.6 更新进度：EP-03-S2 标记 Done（2025-09-06），完成率 5/8。
 - v0.7 更新进度：EP-01-S3 标记 Done（2025-09-06），完成率 6/8。
